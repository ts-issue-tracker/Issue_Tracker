...
def  display(title_ret,des_ret,build_ret,assignee_ret,si_state,cr_state,git):
    print("in display")
    print(title_ret[0],"1",title_ret[1])
    print(des_ret[0],"1",des_ret[1])
    print(build_ret[0],"1",build_ret[1])
    print(assignee_ret[0],"1",assignee_ret[1])
    print(git[0],"1",git[1])
    if(title_ret[1] and des_ret[1] and build_ret[1] and assignee_ret[1] and si_state[1] and cr_state[1] and git[1]):
        print("true")
        return True
    else:
        print("any one false")
